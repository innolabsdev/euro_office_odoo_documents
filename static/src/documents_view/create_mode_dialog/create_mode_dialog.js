...
import { FormGallery } from "@euro_office_odoo/views/form_gallery/form_gallery"
import { CreateDialog } from "@euro_office_odoo_documents/euro_office_create_template/euro_office_create_template_dialog"
  ...
  formGallery() {
    const download = async (form) => {
      ...
      if (result.error) {
        ...
        window.open(`/euro_office/editor/document/${result.document_id}`, "_blank")
      }
    }
...
CreateModeDialog.template = "euro_office_odoo_documents.CreateModeDialog"
